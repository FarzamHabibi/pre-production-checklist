...
> 4,353 things to check before you ship
> Everything to check before production. Free and open source.

## One-liner (Product Hunt "description", ~260 characters)

> A free, open-source pre-production checklist for solo founders — 4,353 items across
...
>
> So it is open source now: **4,353 items across five domains** — security, performance,
...
> Show HN: A 4,353-item pre-production checklist for solo founders
...
>
> It's open source now. 4,353 items. Free.
>
> 🧵
