...
> 4,124 things to check before you ship
> Everything to check before production. Free and open source.

## One-liner (Product Hunt "description", ~260 characters)

> A free, open-source pre-production checklist for solo founders — 4,124 items across
...
>
> So it is open source now: **4,124 items across five domains** — security, performance,
> scale, integrations, and what to do after it goes wrong. 90% of them name no product at
...
> Show HN: A 4,124-item pre-production checklist for solo founders
...
>
> It's open source now. 4,124 items. Free.
>
> 🧵
